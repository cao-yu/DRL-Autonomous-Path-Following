...
if __name__ == '__main__':
    ...
    pp_file = 'log_pp_20231123_2023.csv' 
    ...
    # read results of sac
    if args.seed == 0:
        sac_file = 'log_sac0_20231123_2020.csv' 
    elif args.seed== 1:
        sac_file = 'log_sac1_20231123_2019.csv'  
    elif args.seed == 2:
        sac_file = 'log_sac2_20231123_2017.csv' 
    elif args.seed == 3:
        sac_file = 'log_sac3_20231123_2016.csv'  
    elif args.seed == 4:
        sac_file = 'log_sac4_20231123_2010.csv'  
    ...
    if args.subplots == "hor":
        ...
        plt.subplots_adjust(wspace=0.25, top=0.9, bottom=0.125, left=0.08, right=0.99)
    ...
    #legend = fig.legend(loc='upper right', ncol=1, fontsize=18)
    plt.savefig('exp_change.jpg', format='jpg', dpi=300, bbox_inches='tight', pad_inches=0.05)    
    ...
    ax[1].tick_params(axis='both', labelsize=18)
    legend = ax[1].legend(loc='lower left', ncol=1, fontsize=18)
    legend.get_frame().set_alpha(0.5)
    plt.savefig('exp_change_vel.jpg', format='jpg', dpi=300, bbox_inches='tight', pad_inches=0.05)
    ...
    ax.figure.savefig('exp_change_vel_diff.jpg', format='jpg', dpi=300, bbox_inches='tight', pad_inches=0.05)
    ...
    plt.savefig('exp_change_vel_on_traj.jpg', format='jpg', dpi=300, bbox_inches='tight', pad_inches=0.05)
    plt.show()
