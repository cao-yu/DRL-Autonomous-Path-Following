...
if __name__ == '__main__':
    ...
    # read results of sac
    if args.seed == 0:
        sac_file = 'log_sac0_20231123_1924.csv' 
    elif args.seed == 1:
        sac_file = 'log_sac1_20231123_1939.csv'  
    elif args.seed == 2:
        sac_file = 'log_sac2_20231123_1942.csv' 
    elif args.seed == 3:
        sac_file = 'log_sac3_20231123_1944.csv'  
    elif args.seed == 4:
        sac_file = 'log_sac4_20231123_1945.csv'  
    ...
    plt.savefig('exp_eight.jpg', format='jpg', dpi=300, bbox_inches='tight', pad_inches=0.05)    
    ...
    legend.get_frame().set_alpha(0.5)
    plt.savefig('exp_eight_vel.jpg', format='jpg', dpi=300, bbox_inches='tight', pad_inches=0.05)
    ...
    ax.figure.savefig('exp_eight_vel_diff.jpg', format='jpg', dpi=300, bbox_inches='tight', pad_inches=0.05)
    ...
    ax.tick_params(axis='both', labelsize=18)
    plt.tight_layout()
    plt.savefig('exp_eight_vel_on_traj.jpg', format='jpg', dpi=300, bbox_inches='tight', pad_inches=0.05)
